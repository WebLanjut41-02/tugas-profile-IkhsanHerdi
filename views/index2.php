  ...
  <!-- <nav id="main-nav">
    <div class="row">
      <div class="container">
        ...
        <div class="logo">
          <a href="index.html"><img src="images/ikhsan11.png" alt="logo"></a>
        </div>
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-4 ">
          <div class="div-img-bg">
            <div class="about-img">
              <img src="images/Capture.PNG" class="img-responsive" alt="me">
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="journal-info">
              ...
              <img src="images/IMG_9983.jpg" class="img-responsive" alt="img">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="journal-info">
              ...
              <img src="images/line_69855239020642.jpg" class="img-responsive" alt="img">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="journal-info">
              ...
              <img src="images/1548419771905.jpg" class="img-responsive" alt="img">
    ...
    <div class="container">
      <div class="contact-block1">
        <div class="row">
          ...
          <div class="col-lg-6">
            <form action="<?php echo base_url(); ?>index.php/welcome/back" method="post" role="form" class="contactForm">
              <div class="row">
                ...
                <div class="col-lg-12">
                  <input type="submit" class="btn btn-defeault btn-send" value="Back To Main Menu">
                </div>  
      ...
      <h1 align="center"><b>Comment From</b></h1><br>

    </div>
    
    <!-- isi comment -->
    
    <h1 align="center"><?php echo $nama; ?></h1><br>
    <h1 align="center"><?php echo $email; ?></h1><br>
    <h1 align="center"><?php echo $komen; ?></h1>
